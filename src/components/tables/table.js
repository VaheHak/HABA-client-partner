			...
			_.map(data, (v, k) => (v ?
				<table className="tableT" key={ k }>
					...
					<tr className="trT">
						...
						<th className="thT">{ t.deliveryAddress }</th>
						<th className="thT">{ t.createdDate }</th>
						<th className="thT">{ t.pendingDate }</th>
						<th className="thT">{ t.tookDate }</th>
						<th className="thT">{ t.doneDate }</th>
						<th className="thT">{ t.orderPrice }</th>
						<th className="thT">{ t.status }</th>
						<th className="thT">{ t.edit }</th>
					</tr>
					</thead>
					<tbody>
					<tr className="trT">
						...
						<td className="tdT">
							<Link to={ `/${ v?.partnerId }/${ v?.partnerBranchId }/update_orders/${ v.id }` } title={ t.edit }>
